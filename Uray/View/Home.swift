        ...
        ScrollView(.vertical, showsIndicators: false) {
            VStack(spacing: 15) {
                ...
                ScrollView(.horizontal, showsIndicators: false) {
                    //MARK: - CATEGORY LIST
                    HStack(spacing: 18) {
                        CategoryItem(image: "cat1", title: "Для лицо")
                        
                        CategoryItem(image: "cat2", title: "Для кожы")
                        
                        CategoryItem(image: "cat3", title: "Здравоохранение")
                        
                        CategoryItem(image: "cat4", title: "Рюкзаки")
                    } // END CATEGORY LIST
                    .padding(.vertical)
                }
                //MARK: - PRODUCT LIST
